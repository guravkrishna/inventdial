...
history.pushState(null,null,'EndUserMain.jsp');
...
<body>
<%@include file="EndUserMainHeader.jsp" %>
			...
			<div class="row">
				<div class="dir-hr1">
					<div class="dir-ho-t-tit">
						...
						<form action="endsearchInMain.jsp" name="mysearch"  class="tourz-search-form" >
		...
		<div class="container top-search-main">
			<div class="row">
				<div class="ts-menu">
					...
					<div class="ts-menu-3">
						<div class="">
							<form class="tourz-search-form tourz-top-search-form" name="mysearch" method="" action="searchInMain.jsp">
								<div class="input-field">
			...
			<div class="row">
				...
				<div class="cat-v2-hom-list">
					<ul>
						...
						<li>
							<a href="educationlist.jsp"><img src="images/icon/hcat8.png" alt=""> Education</a>
						</li>
						<li>
						...
						<li>
							<a href="securityserviceslist.jsp"><img src="images/icon/hcat15.png" alt="">Security Services</a>
						</li>
						<li>
				...
				<div class="col-md-6">
					<div>
						...
						<div class="home-list-pop">
							...
							<div class="col-md-3"> <img src="images/care/<%=resultSet.getString("img") %>" alt="" /> </div>
							<!--POPULAR LISTINGS: CONTENT-->
							<div class="col-md-9 home-list-pop-desc"> <a href="automobile_listing_details.jsp"><h3><%=resultSet.getString("category") %></h3></a>
								<h4><%=resultSet.getString("address") %></h4>
								<p>28800 Orchard Lake Road, Suite 180 Farmington Hills,<%=resultSet.getString("city") %></p> <span class="home-list-pop-rat">4.2</span>
						...
						<div class="home-list-pop">
							...
							<!--POPULAR LISTINGS: CONTENT-->
							<div class="col-md-9 home-list-pop-desc"> <a href="property-listing-details.html"><h3><%=resultSet.getString("category") %></h3></a>
...
<!--MOBILE APP-->
								...
								<div class="row">
									...
									<div class="col-sm-4 col-md-3">
										...
										<ul class="one-columns">
											...
											<li> <a href="terms-conditions.jsp">Terms and conditions</a> </li>
											<li> <a href="privacy-policy.jsp">Privacy and policy </a> </li>
											<li> <a href="contact-us.jsp">Costumer care</a> </li>
											<li> <a href="advertise.jsp">Advertise us</a> </li>
						...
						<div data-section="section" class="foot-sec2">
							<div class="container">
								<div class="row">
									...
									<div class="col-sm-4">
										<h4>Address</h4>
										<p>461,3rd floor,sahara building 4th Main Rd, 
											Chennakeshava Nagar, Hosa Road, Parappana Agrahara, 
											Electronic City, Bengaluru, Karnataka 560068</p>
										<p> <span class="strong">Phone: </span> <span class="highlighted">080 4890 8490</span> </p>
									</div>
	...
	<section class="copy">
		<div class="container">
			<p>copyrights Â© 2018 <a href="http://www.trickyglobalsolutions.com/" target="_blank">Tricky Global Solutions</a>. &nbsp;&nbsp;All rights reserved. </p>
		</div>
	</section>
	<!--QUOTS POPUP-->
	<section>
