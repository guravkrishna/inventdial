			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="dir-ho-tl">
						<ul>
							<li>
								<a href="EndUserMain.jsp"><img src="images/logo.gif" alt="" style="width:60%"> </a>
							</li>
						</ul>
					</div>
				</div>
	                 ...
	                 %>  
	                  ...
	                  <li><a href="about_us.jsp">About us</a> </li>
						<li><a href="contact_us.jsp">Contact us</a> </li>
							<!-- <li><a href="Userfreelisting.jsp"> Add Listing</a> </li> -->
							<li><a href="Userfreelisting.jsp"> Welcome :<%=resultSet.getString("firstname") %></a> </li>
