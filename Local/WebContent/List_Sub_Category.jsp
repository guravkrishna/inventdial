...
resultSet = statement.executeQuery(sql);
 %>
			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#">Product Sub-Categories</a> </li>
						<li class="page-back"><a href="admin.html"><i class="fa fa-backward" aria-hidden="true"></i> Back</a> </li>
					</ul>
				</div>
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Product Sub-Categories</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
	...
	%>
													...
													<td> <a href="#?id=<%=resultSet.getString("id")%>"><button type="button" value="edit">Edit</button></a> </td>
														<td> <a href="delete_category.jsp?id=<%=resultSet.getString("id")%>"><button type="button" value="delete">Delete</button></a> </td>
													</tr>
													<% 
}
