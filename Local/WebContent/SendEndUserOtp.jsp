	...
	<section class="tz-register">
			...
			<!--  	<div class="log-in-pop-left">
				...
				<div class="log-in-pop-right">
					...
					<p>Enter your OTP and get to be Register!</p>
					<%
				    ...
				    System.out.println("EmailID :-"+EmailID);
					  ...
					  AlertMail.sendAlertMail(EmailID,msg,otp);  
					
					%>
					
					<form class="s12" action="./InsertServlet" method="post">
				 ...
				 <div><div class="input-field s12">
							...
							<div>
							<div class="input-field s12">
								<input type="hidden"  name="lname"class="validate"  name="lname" required pattern="[a-zA-Z]+"  value='<%=last %>' readonly title="enter  valid name" >
							
							</div>
						</div>
							<div>
							<div class="input-field s12">
								<input type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\." class="" name="con"  value='<%=phone %>' readonly required>
			...
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
				  ...
				  BulkSMS.SMSSender(phone,msg,otp);
					...
					<form class="s12" action="EndUserSession.jsp" method="" name="login" onsubmit="return myFunction1();">
						...
						<!-- <div>
							<div class="input-field s4">
								<input type="text" value="Submit" class="waves-effect waves-light log-in-btn" >Submit </div>
						</div> -->
						<p id="demo"></p>
						<!-- <p id="demo1"></p> -->
					</form>
