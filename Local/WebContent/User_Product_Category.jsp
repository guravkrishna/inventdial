		...
		<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#"> Add Sub-Product</a> </li>
						<li class="page-back"><a href="#"><i class="fa fa-backward" aria-hidden="true"></i> Back</a> </li>
					</ul>
				</div>
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Add Sub-Product</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
						...
						<div class="hom-cre-acc-left hom-cre-acc-right">
							<div class="">
								<form class="" action="Product_SubCategory" method="post" enctype="multipart/form-data">
									<div class="row">
									...
									<div class="row">
										<div class="input-field col s12">
											...
											<label for="first_name">Product Sub-Category Name</label>
										</div>
									...
									<div class="row tz-file-upload">
										<div class="file-field input-field">
											<div class="tz-up-btn"> <span>File</span>
												<input type="file" name="fgal" accept=".png, .jpg, .jpeg" /> </div>
											<div class="file-path-wrapper db-v2-pg-inp">
												<input class="file-path validate" type="text"> 
											</div>
										</div>
									...
									<div class="row tz-file-upload">
										<div class="file-field input-field">
											<div class="tz-up-btn"> <span>File</span>
												<input type="file" name="sgal" accept=".png, .jpg, .jpeg" /> </div>
											<div class="file-path-wrapper db-v2-pg-inp">
												<input class="file-path validate" type="text"> 
											</div>
										</div>
									...
									<div class="row tz-file-upload">
										<div class="file-field input-field">
											<div class="tz-up-btn"> <span>File</span>
												<input type="file" name="tgal" accept=".png, .jpg, .jpeg" /> </div>
											<div class="file-path-wrapper db-v2-pg-inp">
												<input class="file-path validate" type="text"> 
											</div>
										</div>
