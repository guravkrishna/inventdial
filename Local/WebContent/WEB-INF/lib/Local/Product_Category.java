	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			 response.setContentType("text/html;charset=UTF-8");
			    ...
			    PrintWriter out = response.getWriter();
			        String savePath = "G:/Arati_18/LocalSearch/WebContent" + File.separator + SAVE_DIR;
		   	        ...
		   	        // @SuppressWarnings("unused")
		   	         ...
		   	         String query = "INSERT into productlist(productname, producttilte, phone, email, address, productcategory, city, description, galf, gals, galt) values (?,?,?,?,?,?,?,?,?,?,?)";
		   	...
		   	ps.execute();
		       request.getRequestDispatcher("User_Product.jsp").include(request, response);
