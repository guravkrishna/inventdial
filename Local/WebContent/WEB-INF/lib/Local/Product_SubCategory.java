...
/**
 * Servlet implementation class Product_SubCategory
 */
//@WebServlet("/Product_SubCategory")
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
maxFileSize=1024*1024*10,      // 10MB
maxRequestSize=1024*1024*50)
public class Product_SubCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			 response.setContentType("text/html;charset=UTF-8");
			    ...
			    PrintWriter out = response.getWriter();
			        String savePath = "G:/Arati_18/LocalSearch/WebContent" + File.separator + SAVE_DIR;
		   	        ...
		   	        // @SuppressWarnings("unused")
		   	         ...
		   	         String query = "INSERT into subproductlist(productname, producttilte, phone, email, address, productcategory, city, description, galf, gals, galt) values (?,?,?,?,?,?,?,?,?,?,?)";
		   	...
		   	ps.execute();
		       request.getRequestDispatcher("User_Product_Category.jsp").include(request, response);
