								...
								<form name="adminsearch" action="admin-group-search.jsp" onsubmit="return validateSearch()">
									<div class="row" style="margin-left:40px;">
										...
										<div class="input-field col s4">
										  <input type="text" name="citysearch" class="validate"/>
										</div>
									...
									<div class="tab-inn ad-tab-inn">
										<div class="table-responsive">
											<table class="table table-hover">
												...
												String sql ="select * from listing l join category c on l.email=c.email where c.category='"+Business+"' and l.city='"+citysearch+"'";
