			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#">User Export Transaction</a> </li>
										...
										<div class="table-responsive">
											<table class="table table-hover">
													<tr>
                                                         ...
                                                         <form action="/Local/ExcelExportDate" method="get">
                                                          <table>
                                                             <fieldset>
                                                        <legend>Choose Transaction dates</legend>
                                                          ...
                                                          <form action="/Local/ExcelExport" method="get">
                                                           <table>
                                                              <tr><td><input type="submit" value="View and Download All Export Transaction List"></td></tr>
                                                              </table>
                                                          </form>  
