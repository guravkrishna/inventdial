...
<!-- Mirrored from rn53themes.net/themes/demo/directory/automobile-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jul 2018 05:14:08 GMT -->
<head>
...
String sql ="select * from myrating where id=8";
...
%>
	...
	<section class="pg-list-1 pg-list-auto">
		<div class="container">
			<div class="row">
				<div class="pg-list-1-left"> <a href="#"><h3><font size="32">	<font color="blue"><h1>	<b><%=resultSet.getString("businessname") %></b> </h1>  </font></font></h3></a>
					<div class="list-rat-ch"> <span><%=resultSet.getString("businessreviewstars") %></span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i><font size="32">	 </div>
					<h4>Express Avenue Mall, Los Angeles</h4>
					<p><b>Address:</b> 	<h1>	<b><%=resultSet.getString("review_city") %></b> </h1> </p>
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><%=resultSet.getString("review_email") %></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i><%=resultSet.getString("review_mobile") %></li>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> Motor America</h3> </div>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								...
								<div class="row pg-list-ser">
									<ul>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a1.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Car Buying</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a2.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Motor bikes</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a3.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Bike Alteration</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a4.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Repair Shop</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a5.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Insurance</h4> </div>
										</li>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/a6.jpg" alt="" /> </div>
											<div class="pg-list-ser-p2">
												<h4>Sports Bike</h4> </div>
										</li>
									</ul>
								</div>
							</div>
...
%>
							...
							<div class="list-pg-inn-sp">
								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="item active"> <img src="images/slider/a1.jpg" alt="Los Angeles"> </div>
										<div class="item"> <img src="images/slider/a2.jpg" alt="Chicago"> </div>
										<div class="item"> <img src="images/slider/a3.jpg" alt="New York"> </div>
										<div class="item"> <img src="images/slider/a4.jpg" alt="New York"> </div>
									</div>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>new arrival </span> cars & Bikes</h3> </div>
							<div class="list-pg-inn-sp">
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/a1.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>BWM Bikes</h3></a>
										...
										<div class="list-room-type list-rom-ami">
											<ul>
												...
												<li><img src="images/icon/a7.png" alt=""> Max Power:13000 rpm</li>
												<li><img src="images/icon/a4.png" alt=""> Fuel Type:Petrol </li>
												<li><img src="images/icon/a3.png" alt=""> Gears:6</li>
												<li><img src="images/icon/a2.png" alt=""> Brake Type:Disc</li>
												<li><img src="images/icon/a5.png" alt=""> Cylinders:5</li>
												<li><img src="images/icon/a6.png" alt=""> Wheel Size: 17inc</li>
												<li><img src="images/icon/a9.png" alt=""> Wheel Type: Alloy</li>
											</ul>
										</div> <span class="home-list-pop-rat list-rom-pric">0%EMI</span>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/a2.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Canned & Packaged Foods</h3></a>
										<div class="list-rat-ch list-room-rati"> <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> </div>
										<div class="list-room-type list-rom-ami">
											<ul>
												<li>
										...
										</div> <span class="home-list-pop-rat list-rom-pric">15%emi</span>
										<div class="list-enqu-btn">
											<ul>
												<li><a href="#!"><i class="fa fa-usd" aria-hidden="true"></i> Get Quotes</a> </li>
												<li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/a3.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Frozen Foods</h3></a>
										<div class="list-rat-ch list-room-rati"> <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> </div>
										<div class="list-room-type list-rom-ami">
											<ul>
												<li>
										...
										</div> <span class="home-list-pop-rat list-rom-pric">5%emi</span>
										<div class="list-enqu-btn">
											<ul>
												<li><a href="#!"><i class="fa fa-usd" aria-hidden="true"></i> Get Quotes</a> </li>
												<li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
									...
									<form class="col" action="MyratingServlet" method="post">
										...
										<div class="row">
											<div class="input-field col s6">
												<input name="reviewid" type="text" class="validate">
												<label for="reviewid">Review ID</label>
											</div>
											<div class="input-field col s6">
												<input name="businessid" type="number" class="validate">
										...
										<div class="row">
											<div class="input-field col s6">
												<input name="businessname" type="text" class="validate">
												<label for="businessname">Business Name</label>
											</div>
											<div class="input-field col s6">
												<input name="businessreviewstars" type="number" class="validate">
												<label for="businessreviewstars">Business review stars</label>
											</div>
										</div>
										<div class="row">
											<div class="input-field col s6">
												<input name="review_name" type="text" class="validate">
												<label for="review_name">Name</label>
											</div>
											<div class="input-field col s6">
												<input name="review_mobile" type="text" class="validate">
												<label for="review_mobile">Mobile</label>
											</div>
										</div>
										<div class="row">
											<div class="input-field col s6">
												<input name="review_email" type="email" class="validate">
												<label for="review_email">Email</label>
											</div>
											<div class="input-field col s6">
												<input name="review_city" type="text" class="validate">
												<label for="review_city">City</label>
											</div>
										</div>
										<div class="row">
											<div class="input-field col s6">
												<input name="review_review" type="text" class="validate">
												<label for="review_review">Review</label>
											</div>
											<div class="input-field col s6">
												<input name="review_date" type="text" class="validate">
								...
								<div class="list-pg-guar">
									<ul>
										...
										<li>
											...
											<h4>Insurance</h4>
											<p>Upto Rs. 5,000 against damages</p>
										</li>
									</ul> <a class="waves-effect waves-light btn-large full-btn list-pg-btn" data-dismiss="modal" data-toggle="modal" data-target="#list-quo" href="#">Quick Enquiry</a> </div>
							</div>
						</div>
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/automobile-listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jul 2018 05:17:30 GMT -->
</html>
