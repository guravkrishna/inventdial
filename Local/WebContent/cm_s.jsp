...
<%@include file="header.jsp" %>
	...
	<section class="dir-pa-sp-top18 dir-pa-sp-top-bg18 v4-pri-bg18" style="height:600px">
		<div class="rows">
			<div class="container" style="width:70%;">
					<center>
						<br><br>
						<h1 style="color:black">List Of Construction Machinery & Supplies</h1>
				   ...
				   <% 
				       try
				      {
					   ...
					   statement=connection.createStatement();
						String sql1 ="select subcategory from category where category='Construction Machinery & Supplies' group by subcategory";
