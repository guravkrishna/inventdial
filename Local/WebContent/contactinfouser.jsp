										...
										<div class="hom-cre-acc-left hom-cre-acc-right">
											<div class="">
												...
												<div class="row">
													...
													<div class="row">
														<div class="input-field col s12">
															<input name="phone" type="text" class="validate" value="<%=resultSet.getString("phone") %>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" pattern="[0-9][0-9]{9}" title="Enter digits only" maxlength="10" required>
