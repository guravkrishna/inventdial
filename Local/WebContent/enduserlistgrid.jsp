...
String sql ="select * from listing l join category c on l.email=c.email  where c.BusinessTitle='"+title+"'";
System.out.println(sql);
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
	
	<section class="pg-list-1" style="background:url(images/<%=resultSet.getString("coverimg") %>">
		<div class="container">
			<div class="row">
