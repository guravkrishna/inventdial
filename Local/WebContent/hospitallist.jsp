...
<%@include file="header.jsp" %>
	<section class="dir-pa-sp-top2 dir-pa-sp-top-bg2 v4-pri-bg2">
		<div class="rows">
			<div class="container" style="width:70%;">
					<center>
						<br><br>
						<h1 style="color:#ffffff">List Of Hospitals</h1>
				   ...
				   <% 
				       try
				      {
					   ...
					   statement=connection.createStatement();
						String sql1 ="select subcategory from category where category='Hospitals' group by subcategory";
						
						resultSet = statement.executeQuery(sql1);
						while(resultSet.next()){
						%>
						<div class="col-md-6 home-list-pop-desc">
							<div class="pg-revi-re"><img src="images/hospital/1.png" alt="">
