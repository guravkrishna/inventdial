...
String sql ="select * from listing l join category c on l.email=c.email  where l.title='"+title+"'";
System.out.println(sql);
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
	
	<section class="pg-list-1" style="background:url(images/listing/<%=resultSet.getString(19) %>">
		<div class="container">
			<div class="row">
				 <h1 style="color:white"><%=resultSet.getString("title") %></h1>
				...
				<div class="pg-list-1-right">
					<div class="list-enqu-btn pg-list-1-right-p1">
						<ul>
							...
							<li><a href="mailto:"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
							<li><a href="tel:<%=resultSet.getString("phone") %>"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a> </li>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> <%=resultSet.getString("title") %></h3> </div>
									...
									<ul>
										<li class="col-md-4">
											...
											<div class="pg-list-ser-p2">
												<h4><%=resultSet.getString("subcategory") %></h4> </div>
										</li>
										<li class="col-md-4">
