...
%>
	...
	<section class="pg-list-1" style="background:url(uploadimg/<%=resultSet.getString(19) %>">
		<div class="container">
			<div class="row">
					<h1 style="color:white"><%=resultSet.getString(2) %></h1>
				<div class="pg-list-1-left"> <a href="#"></a><br>
					...
					<p><b>Address:</b><h2 style="color:white"><%=resultSet.getString(12) %></h2>
					
					
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i><h4><%=resultSet.getString(5) %></h4></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <h4><%=resultSet.getString(6) %></h4></li>
							<li><i class="fa fa-user" aria-hidden="true"></i><h4><%=resultSet.getString(3) %> <%=resultSet.getString(4) %></h4></li>
						</ul>
					</div>
				</div>
				<div class="pg-list-1-right">
					<div class="list-enqu-btn pg-list-1-right-p1">
						<ul>
							...
							<li><a href="tel:<%=resultSet.getString(5) %>"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a> </li>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> hotel</h3> </div>
							...
							<div class="list-pg-inn-sp">
								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="item active"> <img src="uploadimg/<%=resultSet.getString(23) %>" alt="Los Angeles"> </div>
										<div class="item"> <img src="uploadimg/<%=resultSet.getString(20) %>" alt="Chicago"> </div>
										<div class="item"> <img src="uploadimg/<%=resultSet.getString(21) %>" alt="New York"> </div>
										<div class="item"> <img src="uploadimg/<%=resultSet.getString(22) %>" alt="New York"> </div>
									</div>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								<div class="list-pg-upro">
									...
									<p><%=resultSet.getString(18) %></p> <a class="waves-effect waves-light btn-large full-btn list-pg-btn" href="tel:<%=resultSet.getString(5) %>">Contact User</a> </div>
							</div>
						</div>
						<!--END LISTING DETAILS: LEFT PART 7-->
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								<div class="list-pg-oth-info">
									<ul>
										<li>Today Shop <span class="green-bg"><%=resultSet.getString(13) %></span> </li>
										...
										<li>Open Time <span><%=resultSet.getString(14) %></span> </li>
										<li>Close Time <span><%=resultSet.getString(15) %></span> </li>
									</ul>
								</div>
							</div>
						</div>
