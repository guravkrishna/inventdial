	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			 response.setContentType("text/html;charset=UTF-8");
			    ...
			    PrintWriter out = response.getWriter();
			        String savePath = "G:/Arati_18/LocalSearch/WebContent" + File.separator + SAVE_DIR;
		   	        ...
		   	        // @SuppressWarnings("unused")
		   	         ...
		   	         String query = "INSERT into userproduct(name, title, phone, email, address, category, city, content, photo, img, bimg) values (?,?,?,?,?,?,?,?,?,?,?)";
		   	...
		   	ps.execute();
		       request.getRequestDispatcher("userproduct.jsp").include(request, response);
